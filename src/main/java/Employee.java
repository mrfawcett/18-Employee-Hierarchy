 ...
 * Employee is the root of the hierarchy:
 *
 *     Employee
 *       ├── HourlyEmployee
 *       └── Manager
 *             └── Executive
 *
 * Every field is PRIVATE. Subclasses reach them only through the
 * constructor and the public accessors below. This is the same Employee
 * spec as the 4.3 Hierarchy Design Lab.
 */
public class Employee {
     ...
     * @return a string in the format "name (ID: employeeID)", e.g. "Alice (ID: 101)"
     */
